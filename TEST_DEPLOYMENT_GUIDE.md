...
2. **Software Requirements**
   - Python 3.7 or later
   - Z1 Python tools installed (see `python_tools/README.md`)
...
4. **Network Configuration**
   ...
   - To change: See `BUILD_INSTRUCTIONS.md` "Customizing Network Configuration" section
...
- Controller IP: 192.168.1.222 (matches firmware default)
...
|--------|-------|-------------|---------|
| `--controller` | `-c` | Controller IP address | 192.168.1.222 |
...
=== Topology Deployment ===
Deploying topology to 192.168.1.222...
